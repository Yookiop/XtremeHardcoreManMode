...
//
//    @Inject
//    private XHCMPlugin plugin;
//
//    private int tickCounterMusicTracker = 0;
...
//        log.info("Checking if music track {} is unlocked", trackId);
//
...
//        // Skip if the music track checking is disabled
//        if (!config.checkMusicTrack()) {
//            return;
//        }
//
//        // Skip if player is already permanently dead
...
//
//        // If the track is now unlocked and wasn't before, set permanent death
//        if (isUnlocked && stateChanged) {
//            log.info("Music track 'Rest in Peace' is unlocked, setting permanent death");
//
...
////        }
////
////        tickCounterMusicTracker++;
////
////        // Check music track on regular intervals
////        if (tickCounterMusicTracker >= CHECK_INTERVAL) {
